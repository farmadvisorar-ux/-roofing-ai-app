...
| [Overpass API](https://wiki.openstreetmap.org/wiki/Overpass_API) | Building footprint, `building:levels`, `roof:shape`, `roof:material`, `start_date` | AGPL-3.0 (data ODbL) |
...
src/app/api/properties/*      REST-ish handlers (list/create, detail, enrich, convert to lead)
